...
class Varien_Directory_Factory extends Varien_Object
{
    /**
     ...
     * @return  Varien_Directory_Collection|Varien_File_Object - Varien_Directory_Collection or Varien_File_Object object
     */
