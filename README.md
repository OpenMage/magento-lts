...
- Removed all deprecated Mysql4_ classes (#2730).
If you have old modules/extensions that still use such classes, you have to run 'shell/rename-mysql4-class-to-resource.php` in the command line in order to convert them. Backup all files before running the script.
