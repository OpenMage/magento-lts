...
$ignoreErrors[] = [
    'rawMessage' => 'Cannot access property $title on Varien_Simplexml_Element|false.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/Admin/Model/Config.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Cannot access property $admin on array|Varien_Simplexml_Element.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/Adminhtml/Block/Permissions/Tab/Rolesedit.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Cannot access property $groups on Varien_Simplexml_Element|null.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/Adminhtml/Model/System/Config/Source/Email/Identity.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Cannot access property $sessionId on stdClass|string.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/Api/Model/Server/Wsi/Handler.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Cannot access property $resource on array|Varien_Simplexml_Element.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/Api2/Model/Acl/Global/Rule/Tree.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Cannot access property $title on array|Varien_Simplexml_Element.',
    'count' => 2,
    'path' => __DIR__ . '/../app/code/core/Mage/Api2/Model/Acl/Global/Rule/Tree.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Cannot access property $formatOutput on DOMDocument|null.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/Api2/Model/Renderer/Xml/Writer.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Cannot access property $allowed_selection_types on Mage_Core_Model_Config_Element|false.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/Bundle/Helper/Data.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Cannot access property $events on Mage_Core_Model_Config_Element|false.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/Core/Model/Config.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Cannot access property $model on Mage_Core_Model_Config_Element|false.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/Core/Model/Config.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Cannot access property $global on Mage_Core_Model_Config_Element|false.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/Core/Model/Resource.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Cannot access property $stores on Mage_Core_Model_Config_Element|false.',
    'count' => 2,
...
$ignoreErrors[] = [
    'rawMessage' => 'Cannot access property $dbname on Mage_Core_Model_Config_Element|false.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/Install/Model/Installer/Config.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Cannot access property $host on Mage_Core_Model_Config_Element|false.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/Install/Model/Installer/Config.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'rawMessage' => 'Cannot access property $username on Mage_Core_Model_Config_Element|false.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/Install/Model/Installer/Config.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'rawMessage' => 'Cannot access property $nodeName on DOMNode|null.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/Reports/Model/Test.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Cannot access property $nodeType on DOMNode|null.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/Reports/Model/Test.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Cannot access property $nodeValue on DOMNode|null.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/Reports/Model/Test.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Cannot access property $conditions on SimpleXMLElement|false.',
    'count' => 1,
