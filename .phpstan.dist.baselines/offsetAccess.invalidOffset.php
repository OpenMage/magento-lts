...
$ignoreErrors[] = [
    'rawMessage' => 'Possibly invalid array key type int|string|false.',
    'count' => 1,
...
$ignoreErrors[] = [
    'rawMessage' => 'Possibly invalid array key type int|Mage_Eav_Model_Entity_Attribute_Interface|string.',
    'count' => 2,
...
$ignoreErrors[] = [
    'rawMessage' => 'Possibly invalid array key type int|Mage_Core_Model_Config_Element|string.',
    'count' => 3,
...
$ignoreErrors[] = [
    'rawMessage' => 'Possibly invalid array key type int|void.',
    'count' => 1,
...
$ignoreErrors[] = [
    'rawMessage' => 'Possibly invalid array key type int|string|false|null.',
    'count' => 2,
    'path' => __DIR__ . '/../app/code/core/Mage/Core/Model/App.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'rawMessage' => 'Possibly invalid array key type string|Zend_Filter_Interface.',
    'count' => 2,
...
$ignoreErrors[] = [
    'rawMessage' => 'Possibly invalid array key type int|string|void.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/ImportExport/Model/Export/Entity/Product.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'rawMessage' => 'Possibly invalid array key type float|int|string|null.',
    'count' => 2,
...
$ignoreErrors[] = [
    'rawMessage' => 'Possibly invalid array key type string|true.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/Page/Block/Html/Breadcrumbs.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'rawMessage' => 'Possibly invalid array key type int|string|null.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/Reports/Model/Event.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Possibly invalid array key type int|string|null.',
    'count' => 2,
...
$ignoreErrors[] = [
    'rawMessage' => 'Possibly invalid array key type int|string|null.',
    'count' => 1,
    'path' => __DIR__ . '/../app/code/core/Mage/Sales/Block/Payment/Form/Billing/Agreement.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Possibly invalid array key type int|string|null.',
    'count' => 1,
...
$ignoreErrors[] = [
    'rawMessage' => 'Possibly invalid array key type int|null.',
    'count' => 2,
    'path' => __DIR__ . '/../app/code/core/Mage/Sales/Model/Order/Status.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Possibly invalid array key type int|string|null.',
    'count' => 2,
...
$ignoreErrors[] = [
    'rawMessage' => 'Possibly invalid array key type float|int|string|true.',
    'count' => 1,
    'path' => __DIR__ . '/../lib/Varien/File/Uploader.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Possibly invalid array key type object|string.',
    'count' => 2,
