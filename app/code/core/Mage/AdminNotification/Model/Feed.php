...
class Mage_AdminNotification_Model_Feed extends Mage_Core_Model_Abstract
{
    ...
    {
        if (($this->getFrequency() + $this->getLastUpdate()) > Mage::helper('core/clock')->now()->getTimestamp()) {
            return $this;
        }
    ...
    {
        Mage::app()->saveCache(Mage::helper('core/clock')->now()->getTimestamp(), 'admin_notifications_lastcheck');
        return $this;
    }
