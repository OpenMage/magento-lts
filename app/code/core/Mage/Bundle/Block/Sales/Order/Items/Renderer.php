...
class Mage_Bundle_Block_Sales_Order_Items_Renderer extends Mage_Sales_Block_Order_Item_Renderer_Default
{
    ...
    public function isShipmentSeparately($item = null)
    {
        ...
        if (($options = $this->getOrderItem()->getProductOptions()) && (isset($options['shipment_type'])
            && $options['shipment_type'] == Mage_Catalog_Model_Product_Type_Abstract::SHIPMENT_SEPARATELY)) {
            return true;
        }
        return false;
    ...
    public function isChildCalculated($item = null)
    {
        ...
        if (($options = $this->getOrderItem()->getProductOptions()) && (isset($options['product_calculations'])
            && $options['product_calculations'] == Mage_Catalog_Model_Product_Type_Abstract::CALCULATE_CHILD)) {
            return true;
        }
        return false;
