...
class Mage_Adminhtml_Catalog_Category_AttributeController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        $this->_initAction()
            ->_addContent($this->getLayout()->createBlock('adminhtml/catalog_category_attribute'))
            ->renderLayout();
    }
