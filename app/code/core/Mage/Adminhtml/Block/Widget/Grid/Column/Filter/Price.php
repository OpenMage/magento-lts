    ...
    extends Mage_Adminhtml_Block_Widget_Grid_Column_Filter_Abstract
{
    ...
    public function getHtml()
    {
        ...
        $html .= '<div class="range-line"><input type="text" placeholder="' . $this->quoteEscape(Mage::helper('adminhtml')->__('From')) . '" aria-label="' . $this->quoteEscape(Mage::helper('adminhtml')->__('From')) . '" name="'.$this->_getHtmlName().'[from]" id="'.$this->_getHtmlId().'_from" value="'.$this->getEscapedValue('from').'" class="input-text no-changes"/></div>';
        $html .= '<div class="range-line"><input type="text" placeholder="' . $this->quoteEscape(Mage::helper('adminhtml')->__('To')) . '" aria-label="' . $this->quoteEscape(Mage::helper('adminhtml')->__('To')) . '" name="'.$this->_getHtmlName().'[to]" id="'.$this->_getHtmlId().'_to" value="'.$this->getEscapedValue('to').'" class="input-text no-changes"/></div>';
