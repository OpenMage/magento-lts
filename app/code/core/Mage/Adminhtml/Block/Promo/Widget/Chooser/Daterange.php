    ...
    protected function _toHtml()
    {
        ...
        return $form->toHtml() . "<script type=\"text/javascript\">
            dateTimeChoose_{$idSuffix} = function() {
                document.getElementById('{$this->_targetElementId}').value = document.getElementById('from_{$idSuffix}').value + '{$this->_rangeDelimiter}' + document.getElementById('to_{$idSuffix}').value;
            };
            </script>";
    }
