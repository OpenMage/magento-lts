...
/**
 * Adminhtml catalog category sets main page toolbar
 *
 * @category   Mage
 * @package    Mage_Adminhtml
...
class Mage_Adminhtml_Block_Catalog_Category_Attribute_Set_Toolbar_Main extends Mage_Adminhtml_Block_Template
{
