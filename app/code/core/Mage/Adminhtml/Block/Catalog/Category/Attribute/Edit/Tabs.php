 ...
 */
class Mage_Adminhtml_Block_Catalog_Category_Attribute_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('main', array(
            ...
            'content'   => $this->getLayout()->createBlock('adminhtml/catalog_category_attribute_edit_tab_main')->toHtml(),
            'active'    => true
        ));
        ...
        $this->addTab('labels', array(
            ...
            'content'   => $this->getLayout()->createBlock('adminhtml/catalog_category_attribute_edit_tab_options')->toHtml(),
        ));
