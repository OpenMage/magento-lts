...
class Mage_Adminhtml_Block_Catalog_Category_Attribute_Set_Main_Formgroup extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $form->setMethod('post');
        $form->setAction($this->getUrl('*/catalog_category_group/save'));
        $this->setForm($form);
        return $this;
    }
