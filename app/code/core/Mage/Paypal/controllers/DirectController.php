 ...
 *
 */
class Mage_Paypal_DirectController extends Mage_Core_Controller_Front_Action
{
    /**
    ...
    public function lookupAction()
    {
        ...
        if ($this->_getValidation()->getEnrolled() == 'Y'
            ...
            $result = array('iframeUrl'=>Mage::getUrl('paypal/direct/validate', array('_secure' => true)));
        } else {
            $result = array('iframeUrl'=>Mage::getUrl('paypal/direct/finalizeValidate', array('_secure' => true)));
        }
