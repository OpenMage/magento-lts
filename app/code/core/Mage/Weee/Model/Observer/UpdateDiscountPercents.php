 ...
 * @package    Mage_Weee
 */
class Mage_Weee_Model_Observer_UpdateDiscountPercents extends Mage_Core_Model_Abstract implements Mage_Core_Observer_Interface
{
    /**
    ...
    public function execute(Varien_Event_Observer $observer): void
    {
        ...
        $productCondition = $observer->getEvent()->getDataByKey('product_condition');
        if ($productCondition) {
