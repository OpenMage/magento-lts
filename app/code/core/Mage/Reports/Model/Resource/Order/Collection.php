...
class Mage_Reports_Model_Resource_Order_Collection extends Mage_Sales_Model_Resource_Order_Collection
{
    ...
    protected function _getRangeExpression($range)
    {
        $expression = match ($range) {
            ...
            Mage_Reports_Helper_Data::PERIOD_7_DAYS, Mage_Reports_Helper_Data::PERIOD_1_MONTH => $this->getConnection()->getDateFormatSql('{{attribute}}', '%Y-%m-%d'),
    ...
    public function getDateRange($range, $customStart, $customEnd, $returnObjects = false)
    {
        ...
        switch ($range) {
            ...
            case Mage_Reports_Helper_Data::PERIOD_2_YEARS:
                $startMonthDay = explode(',', (string) Mage::getStoreConfig('reports/dashboard/ytd_start'));
