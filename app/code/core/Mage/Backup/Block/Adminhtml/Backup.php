 ...
 */
class Mage_Backup_Block_Adminhtml_Backup extends Mage_Adminhtml_Block_Template
{
    /**
     * Block's template
     *
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild('backupsGrid',
            $this->getLayout()->createBlock('backup/adminhtml_grid')
        );

        $this->setChild('dialogs', $this->getLayout()->createBlock('backup/adminhtml_dialogs'));
        return $this;
    }
