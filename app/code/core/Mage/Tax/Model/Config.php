...
class Mage_Tax_Model_Config
{
     ...
     * display and ignore flags
     */
    public const XML_PATH_TAX_DISPLAY_NOTIFICATION_DISCOUNT = 'tax/display_notification/discount';
    public const XML_PATH_TAX_DISPLAY_NOTIFICATION_PRICE_DISPLAY = 'tax/display_notification/price_display';
    public const XML_PATH_TAX_DISPLAY_NOTIFICATION_FPT_CONFIGURATION = 'tax/display_notification/fpt_configuration';
