    ...
    public function indexProductImages($product, $preValues = null)
    {
        ...
        if (!isset($this->_productImagesByLabel[$product->getId()])) {
            ...
            foreach ($searchValues as $label) {
                ...
                if (($imageKeys[$label] === false) && array_keys($mapping, $label) && isset($mapping[$label]['default_label'])) {
                ...
                if (($imageKeys[$swatchLabel] === false) && array_keys($mapping, $label) && isset($mapping[$label]['default_label'])) {
