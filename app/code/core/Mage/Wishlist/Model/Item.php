...
class Mage_Wishlist_Model_Item extends Mage_Core_Model_Abstract implements Mage_Catalog_Model_Product_Configuration_Item_Interface
{
    ...
    {
        return ['product_id' => $this->getProductId(), 'wishlist_id' => $this->getWishlistId(), 'added_at' => $this->getAddedAt() ?: Mage::getSingleton('core/date')->gmtDate(), 'description' => $this->getDescription(), 'store_id' => $this->getStoreId() ?: Mage::app()->getStore()->getId()];
    }
