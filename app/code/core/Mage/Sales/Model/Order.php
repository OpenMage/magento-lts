...
class Mage_Sales_Model_Order extends Mage_Sales_Model_Abstract
{
    ...
    protected function _setState(
        ...
        if ($status) {
            ...
            $history = $this->addStatusHistoryComment($comment); // no sense to set $status again
    ...
    {
        $orderId = $this->getData('real_order_id');
        if (is_null($orderId)) {
