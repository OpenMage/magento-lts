...
class Mage_Usa_Model_Shipping_Carrier_Dhl_Label_Pdf_PageBuilder
{
    ...
    public function addSenderInfo(SimpleXMLElement $sender)
    {
        ...
        $contactName = implode(
            ' ',
            array_filter([(string)$sender->CompanyName,
        ...
        $phoneNumber = implode(
            ' ',
            array_filter([(string)$sender->Contact->PhoneNumber,
    ...
    public function addReceiveInfo(SimpleXMLElement $consignee)
    {
        ...
        $cityInfo = implode(
            ' ',
            array_filter([$consignee->PostalCode, $consignee->City,
        ...
        $phoneNumber = implode(
            ' ',
            array_filter([$consignee->Contact->PhoneNumber,
