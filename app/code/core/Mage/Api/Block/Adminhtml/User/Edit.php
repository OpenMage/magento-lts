 ...
 */
class Mage_Api_Block_Adminhtml_User_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     * Mage_Api_Block_Adminhtml_User_Edit constructor.
     */
    ...
    {
        $user = Mage::registry('api_user');
        if ($user->getId()) {
            return Mage::helper('adminhtml')->__("Edit User '%s'", $this->escapeHtml($user->getUsername()));
        }
