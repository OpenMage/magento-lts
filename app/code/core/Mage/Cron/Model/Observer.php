...
class Mage_Cron_Model_Observer
{
    ...
    public function generate()
    {
         ...
         */
        Mage::app()->saveCache(Mage::helper('core/clock')->now()->getTimestamp(), self::CACHE_KEY_LAST_SCHEDULE_GENERATE_AT, ['crontab'], null);
    ...
    protected function _generateJobs($jobs, $exists)
    {
        ...
        foreach ($jobs as $jobCode => $jobConfig) {
            ...
            $now = Mage::helper('core/clock')->now()->getTimestamp();
    ...
    public function cleanup()
    {
        ...
        Mage::app()->saveCache(Mage::helper('core/clock')->now()->getTimestamp(), self::CACHE_KEY_LAST_HISTORY_CLEANUP_AT, ['crontab'], null);
    ...
    protected function _getAlwaysJobSchedule($jobCode)
    {
        ...
        if ($schedule->getId() === null) {
            $timestamp = Mage::helper('core/clock')->now()->format('Y-m-d H:i:00');
            $schedule->setJobCode($jobCode)
