...
namespace PHPSTORM_META {
    override( \Mage::helper(0),
        map( [
            'fballiano_ga4enhancedcomerce' => \Fballiano_Ga4EnhancedComerce_Helper_Data::class,
            'fballiano_ga4enhancedcomerce/data' => \Fballiano_Ga4EnhancedComerce_Helper_Data::class,
            ...
            'poll/data' => \Mage_Poll_Helper_Data::class,
            'poll' => \Mage_Poll_Helper_Data::class,
