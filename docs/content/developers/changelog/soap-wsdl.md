...
If your custom modules extends OpenMage's API with a custom WSDL file and there are some hard-coded `targetNamespace="urn:Magento"` strings, your APIs may stop working.
