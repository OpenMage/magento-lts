...
If your custom modules extends OpenMage's APIs with a custom WSDL file and there are some hard-coded `targetNamespace="urn:Magento"` string, your APIs may stop working.
