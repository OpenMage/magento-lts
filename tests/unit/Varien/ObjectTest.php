...
class ObjectTest extends TestCase
{
    ...
    public function testToString(): void
    {
        ...
        static::assertSame('open, mage', $this->subject->toString());
        static::assertSame('openmage', $this->subject->toString('{{string1}}{{string2}}'));
        static::assertSame('open', $this->subject->toString('{{string1}}{{string_not_exists}}'));
    }
