...
use Mage;
use Mage_Adminhtml_Block_Sales_Order_Shipment_Create_Tracking;
use Mage_Core_Model_Layout;
use PHPUnit\Framework\TestCase;

class TrackingTest extends TestCase
{
    private static ?Mage_Adminhtml_Block_Sales_Order_Shipment_Create_Tracking $subject;

    public static function setUpBeforeClass(): void
    {
        Mage::app();
        self::$subject = new Mage_Adminhtml_Block_Sales_Order_Shipment_Create_Tracking();
    }
    ...
    /**
     * @covers Mage_Adminhtml_Block_Sales_Order_Shipment_Create_Tracking::getButtonAddBlock()
