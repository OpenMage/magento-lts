...
use Mage;
use Mage_Adminhtml_Block_Catalog_Product_Created;
use Mage_Core_Model_Layout;
use PHPUnit\Framework\TestCase;

class CreatedTest extends TestCase
{
    private static ?Mage_Adminhtml_Block_Catalog_Product_Created $subject;

    public static function setUpBeforeClass(): void
    {
        Mage::app();
        self::$subject = new Mage_Adminhtml_Block_Catalog_Product_Created();
    }
    ...
    /**
     * @covers Mage_Adminhtml_Block_Catalog_Product_Created::getButtonCloseBlock()
    ...
    public function testGetButtonCloseBlock(): void
    {
        ...
        $this->assertSame('addProduct(true)', $result->getOnClick());
