...
use Mage;
use Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Options;
use Mage_Core_Model_Layout;
use PHPUnit\Framework\TestCase;

class OptionsTest extends TestCase
{
    private static ?Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Options $subject;

    public static function setUpBeforeClass(): void
    {
        Mage::app();
        self::$subject = new Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Options();
    }
    ...
    /**
     * @covers Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Options::getButtonAddBlock()
    ...
    public function testGetButtonAddBlock(): void
    {
        ...
        $this->assertSame('add_new_defined_option', $result->getId());
