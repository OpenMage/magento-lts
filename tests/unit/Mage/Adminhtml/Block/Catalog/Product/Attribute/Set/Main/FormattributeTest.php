...
use Mage;
use Mage_Adminhtml_Block_Catalog_Product_Attribute_Set_Main_Formattribute;
use Mage_Core_Model_Layout;
use PHPUnit\Framework\TestCase;

class FormattributeTest extends TestCase
{
    private static ?Mage_Adminhtml_Block_Catalog_Product_Attribute_Set_Main_Formattribute $subject;

    public static function setUpBeforeClass(): void
    {
        Mage::app();
        self::$subject = new Mage_Adminhtml_Block_Catalog_Product_Attribute_Set_Main_Formattribute();
    }
    ...
    /**
     * @covers Mage_Adminhtml_Block_Catalog_Product_Attribute_Set_Main_Formattribute::getButtonAddBlock()
    ...
    public function testGetButtonAddBlock(): void
    {
        ...
        $this->assertSame('Add Attribute', $result->getLabel());
