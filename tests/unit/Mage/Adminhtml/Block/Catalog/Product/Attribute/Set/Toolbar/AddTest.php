...
use Mage;
use Mage_Adminhtml_Block_Catalog_Product_Attribute_Set_Toolbar_Add;
use Mage_Core_Model_Layout;
use PHPUnit\Framework\TestCase;

class AddTest extends TestCase
{
    private static ?Mage_Adminhtml_Block_Catalog_Product_Attribute_Set_Toolbar_Add $subject;

    public static function setUpBeforeClass(): void
    {
        Mage::app();
        self::$subject = new Mage_Adminhtml_Block_Catalog_Product_Attribute_Set_Toolbar_Add();
    }
    ...
    /**
     * @covers Mage_Adminhtml_Block_Catalog_Product_Attribute_Set_Toolbar_Add::getButtonBackBlock()
    ...
    /**
     * @covers Mage_Adminhtml_Block_Catalog_Product_Attribute_Set_Toolbar_Add::getButtonSaveGroupBlock()
     * @group Mage_Adminhtml
     * @group Mage_Adminhtml_Block
     * @group Mage_Adminhtml_Block_Catalog
     * @group AdminhtmlButtons
    ...
    public function testGetButtonSaveBlock(): void
    {
        ...
        $result = self::$subject->getButtonSaveGroupBlock();
        $this->assertSame('Save Attribute Set', $result->getLabel());
        $this->assertSame('if (addSet.submit()) disableElements(\'save\');', $result->getOnClick());
