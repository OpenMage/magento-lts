...
use Mage;
use Mage_Adminhtml_Block_System_Store_Delete_Website;
use Mage_Core_Model_Layout;
use PHPUnit\Framework\TestCase;

class WebsiteTest extends TestCase
{
    private static ?Mage_Adminhtml_Block_System_Store_Delete_Website $subject;

    public static function setUpBeforeClass(): void
    {
        Mage::app();
        self::$subject = new Mage_Adminhtml_Block_System_Store_Delete_Website();
    }
    ...
    /**
     * @covers Mage_Adminhtml_Block_System_Store_Delete_Website::getButtonBackBlock()
    ...
    /**
     * @covers Mage_Adminhtml_Block_System_Store_Delete_Website::getButtonCancelBlock()
     * @group Mage_Adminhtml
     * @group Mage_Adminhtml_Block
     * @group Mage_Adminhtml_Block_System
     * @group AdminhtmlButtons
    ...
    /**
     * @covers Mage_Adminhtml_Block_System_Store_Delete_Website::getButtonConfirmDeleteBlock()
     * @group Mage_Adminhtml
     * @group Mage_Adminhtml_Block
     * @group Mage_Adminhtml_Block_System
     * @group AdminhtmlButtons
