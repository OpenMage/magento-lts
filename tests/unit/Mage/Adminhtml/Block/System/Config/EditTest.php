...
use Mage;
use Mage_Adminhtml_Block_System_Config_Edit;
use Mage_Core_Model_Layout;
use PHPUnit\Framework\TestCase;

class EditTest extends TestCase
{
    private static ?Mage_Adminhtml_Block_System_Config_Edit $subject;

    public static function setUpBeforeClass(): void
    {
        Mage::app();
        self::$subject = new Mage_Adminhtml_Block_System_Config_Edit();
    }
    ...
    /**
     * @covers Mage_Adminhtml_Block_System_Config_Edit::getButtonSaveBlock()
    ...
    public function testGetButtonSaveBlock(): void
    {
        ...
        $this->assertSame('Save Config', $result->getLabel());
