...
{
    private static ?Mage_Adminhtml_Block_Permissions_Buttons $subject;

    public static function setUpBeforeClass(): void
    {
        Mage::app();
        self::$subject = new Mage_Adminhtml_Block_Permissions_Buttons();
    }
    ...
    /**
     * @covers Mage_Adminhtml_Block_Permissions_Buttons::getButtonBackBlock()
     * @group Mage_Adminhtml
     * @group Mage_Adminhtml_Block
     * @group Mage_Adminhtml_Block_Permissions
    ...
    /**
     * @covers Mage_Adminhtml_Block_Permissions_Buttons::getButtonDeleteBlock()
     * @group Mage_Adminhtml
     * @group Mage_Adminhtml_Block
     * @group Mage_Adminhtml_Block_Permissions
     * @group AdminhtmlButtons
    ...
    /**
     * @covers Mage_Adminhtml_Block_Permissions_Buttons::getButtonResetBlock()
     * @group Mage_Adminhtml
     * @group Mage_Adminhtml_Block
     * @group Mage_Adminhtml_Block_Permissions
     * @group AdminhtmlButtons
    ...
    /**
     * @covers Mage_Adminhtml_Block_Permissions_Buttons::getButtonSaveBlock()
     * @group Mage_Adminhtml
     * @group Mage_Adminhtml_Block
     * @group Mage_Adminhtml_Block_Permissions
     * @group AdminhtmlButtons
