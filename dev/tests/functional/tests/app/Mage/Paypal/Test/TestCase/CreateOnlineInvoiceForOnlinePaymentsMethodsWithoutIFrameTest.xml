...
<config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="../../../../../../vendor/magento/mtf/etc/variations.xsd">
    <testCase name="Mage\Paypal\Test\TestCase\CreateOnlineInvoiceForOnlinePaymentsMethodsWithoutIFrameTest">
        <variation name="CreateOnlineInvoiceForOnlinePaymentsMethodsWithoutIFrameTestVariation1" method="test">
            ...
            <data name="tag" xsi:type="string">paypal:payments_pro</data>
        ...
        <variation name="CreateOnlineInvoiceForOnlinePaymentsMethodsWithoutIFrameTestVariation2" method="test">
            <data name="description" xsi:type="string">Create full invoice with shipment for paypal payments pro.</data>
            ...
            <data name="verifyData/items_data/0/item_subtotal" xsi:type="string">15.00</data>
            <data name="verifyData/items_data/0/item_row_total" xsi:type="string">15.00</data>
            <data name="status" xsi:type="string">Complete</data>
            <data name="tag" xsi:type="string">payment_method:paypal</data>
            <data name="tag" xsi:type="string">paypal:payflow_pro</data>
            <constraint name="Mage\Sales\Test\Constraint\AssertInvoiceWithShipmentSuccessMessage" />
            <constraint name="Mage\Sales\Test\Constraint\AssertInvoiceInInvoicesGrid" />
            <constraint name="Mage\Sales\Test\Constraint\AssertInvoiceInInvoicesTab" />
            <constraint name="Mage\Sales\Test\Constraint\AssertNoInvoiceButton" />
