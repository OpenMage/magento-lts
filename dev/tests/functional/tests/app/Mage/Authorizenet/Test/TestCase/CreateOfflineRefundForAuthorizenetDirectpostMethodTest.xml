...
<config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="../../../../../../vendor/magento/mtf/etc/variations.xsd">
    <testCase name="Mage\Authorizenet\Test\TestCase\CreateOfflineRefundForAuthorizenetDirectpostMethodTest">
        <variation name="CreateOfflineRefundForAuthorizenetDirectpostMethodTestVariation1" method="test">
            <data name="description" xsi:type="string">Create full refund for Authorize.net direct post</data>
        ...
        <variation name="CreateOfflineRefundForAuthorizenetDirectpostMethodTestVariation2" method="test">
            <data name="description" xsi:type="string">Create partial credit memo for Authorize.net direct post</data>
            <data name="products" xsi:type="string">catalogProductSimple::default</data>
            <data name="configData" xsi:type="string">authorizenet_directpost</data>
            <data name="customer/dataSet" xsi:type="string">default</data>
            <data name="checkoutMethod" xsi:type="string">login</data>
            ...
            <data name="payment/cc" xsi:type="string">for_iframe</data>
            <data name="payment/iframe" xsi:type="string">yes</data>
            <data name="action/invoice/0" xsi:type="boolean">true</data>
